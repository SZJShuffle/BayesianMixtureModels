...
##################### ABOUT THE DATA ########################
## Suppose we have a mixture of 3 bivariate-normal distribution.
## The pdf was writen as following:
##  f(x) = 0.5 * N(c(0,0), matrix(c(1,0,0,1),p,p)) + 0.3 * N(c(5,5)),matrix(c(2,0.9,0.9,1),p,p) ) + 0.2 * N(c(-3,7),matrix(c(1,-0.9,-0.9,4),p,p) )
## where p=2
...
####### step1: Generate data from a mixture with 3 components ####### 
KK      = 3  ## number of component
p       = 2
